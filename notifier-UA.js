(() => {
  ...
  const NOTIFY_TEXT_REGEXP =
    "(?!Львів)(?!Чернігів)(?!Кам’янець-Подільський)(?!Дніпро)(?!Днепр)(?!Рівне)(?!Київ)(?!Вінниця)(?!Житомир)(?!Харков)(?!Харків)((тривога.*Хмельницьк)|(Хмельницьк.*тривога)|(cирена.*Хмельницьк)|(Хмельницьк.*cирена))";
